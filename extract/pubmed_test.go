...
func TestGetSimplePubmedFields(t *testing.T) {
	...
	//pubMedFields, _ := GetSimplePubmedFields("/cluster/home/ljf/repositories/github/openanno/COVID-19-connections/data/pubmed/xml/covid19.XML.tmp49.json", nil, &pat, true, 60)
